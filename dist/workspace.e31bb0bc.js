    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          _breedSelect.addEventListener("change", handleBreedSelection);
 ...
 */
function handleBreedSelection(_x) {
  return _handleBreedSelection.apply(this, arguments);
} // Attach the event listener to breedSelect
function _handleBreedSelection() {
  _handleBreedSelection = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
    var breedId, breedName, apiUrl, response, breedImages, _infoDump, breed, infoContent;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          breedId = event.target.value;
          breedName = event.target.options[event.target.selectedIndex].text;
          apiUrl = "https://api.thecatapi.com/v1/images/search?breed_ids=".concat(breedId, "&limit=10&hasBreed=1&api_key=").concat(API_KEY);
          _context2.prev = 3;
          _context2.next = 6;
          return fetch(apiUrl);
        case 6:
        ...
        case 9:
          ...
          breedImages.forEach(function (image) {
            ...
            console.log(image);
            var carouselElement = (0, _Carousel.createCarouselItem)(image.url, "Image of ".concat(breedName), image.id);
            (0, _Carousel.appendCarousel)(carouselElement);
          }); // Update infoDump with breed information
          _infoDump = document.getElementById("infoDump");
          _infoDump.innerHTML = ""; // Clear existing content

          if (breedImages.length > 0 && breedImages[0].breeds.length > 0) {
            breed = breedImages[0].breeds[0];
            infoContent = document.createElement("div"); // Add the breed's name, description, and other details you want to display
            infoContent.innerHTML = "\n        <h3>".concat(breed.name, "</h3>\n        <p>").concat(breed.description, "</p>\n        <p>Temperament: ").concat(breed.temperament, "</p>\n        <p>Life Span: ").concat(breed.life_span, " years</p>\n        <p>Weight: ").concat(breed.weight.metric, " kg</p>\n        <p>Origin: ").concat(breed.origin, "</p>\n      ");
            _infoDump.appendChild(infoContent);
          } else {
            _infoDump.innerHTML = "<p>Breed information not available.</p>";
          }
          _context2.next = 20;
          break;
        case 17:
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "40777" + '/');
